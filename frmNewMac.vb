...
Catalog:
    ...
    Public Sub AddVM(s As String)
        ...
        Try
            IO.File.WriteAllText(savepath, ";VirtualMac Configuration File" & Environment.NewLine & ";DO NOT EDIT THIS FILE!" & Environment.NewLine & "Version: 1.0" & Environment.NewLine & "name=" & MacName & Environment.NewLine & "mem=" & VMemory & Environment.NewLine & "cpu=" & CPUArch.Text & Environment.NewLine & "desc=" & "Description.")
        ...
        Catch ex As Exception
            MsgBox("Cannot save the .mcc file. Make sure you have permissons to save to the folder you selected and that it exists." + ex.Message + ex.StackTrace, MsgBoxStyle.Critical)
            Exit Sub
        End Try
