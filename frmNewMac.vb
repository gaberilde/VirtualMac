...
Catalog:
    ...
    Public Sub AddVM(s As String)
        ...
        Try
            IO.File.WriteAllText(savepath, ";VirtualMac Configuration File" & Environment.NewLine & ";DO NOT EDIT THIS FILE!" & Environment.NewLine & "Version: 1.0" & Environment.NewLine & "name=" & MacName & Environment.NewLine & "mem=" & VMemory & Environment.NewLine & "cpu=" & CPUArch.Text & Environment.NewLine & "desc=" & "Description." & Environment.NewLine & "hddpath=" & NewMac7VDName.Text)
